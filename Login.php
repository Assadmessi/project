...
function StudentLogin($username,$password)
{
 $query="Select * From student 
...
else
  {
    ...
    $_SESSION['StudentName']=$data['StudentName'];
    echo "<script>
      alert('Welcome');
      location.assign('Course_Display.php');
      </script>";
  }
} 
...
function AdminLogin($username,$password)
{
  ...
  {
    $data=mysql_fetch_array($ret);
   echo $_SESSION['AdminID']=$data['AdminID'];
   
    echo "<script>     alert('Welcome');     location.assign('Add_Course.php');      </script>";
  }
}   
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
          <nav class="link-effect-3" id="link-effect-3">
            <ul class="nav navbar-nav">
              <li><a href="Course_Display.php" data-hover="Home">Home</a></li>
              <li class="active"><a href="Login.php" data-hover="About Us">Login</a></li>
...
<div class="table">
  ...
  <h3 class="tittle-agileits-w3layouts">Log in</h3>
  </div>
